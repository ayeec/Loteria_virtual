...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <asp:SqlDataSource ID="SQLDSJugadores" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" 
         ...
         <EditItemTemplate>
             <tr class="itemRowAlt">
                 ...
                 <td>
                    ...
                    <asp:SqlDataSource ID="sqlUsuariosDisponibles" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" 
