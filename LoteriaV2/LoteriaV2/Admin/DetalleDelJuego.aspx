...
<br /></span>
    ...
    <asp:SqlDataSource ID="SQLDSHistorialJuego" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" 
...
WHERE hr.INTIDJUEGO = @idJuego">
    ...
    <asp:SqlDataSource ID="SQLDSDetalle" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" 
        SelectCommand="
