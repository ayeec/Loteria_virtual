...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDSFrases" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" 
...
WHERE (c.INTCVECARTA = CASE WHEN  @INTCVECARTA > 0 THEN @INTCVECARTA ELSE c.[INTCVECARTA] END) "
    ...
    <asp:SqlDataSource ID="SqlDSIDCartas" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" SelectCommand="SELECT INTCVECARTA, CONCAT(INTCVECARTA, ' - ', VCHNOMBRE) as nameCarta FROM cartas"></asp:SqlDataSource>
