...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <h1 id="h1Title" runat="server">h1Title</h1>
     ...
     <asp:TextBox ID="INTIDCATEGORIATextBox" runat="server" Text='<%# Bind("INTIDCATEGORIA") %>' Visible="false"/>
                    ...
                    <asp:SqlDataSource ID="SQLDSCategorias" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" 
    ...
    <asp:SqlDataSource ID="SQLDSCategoriasDelJugador" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" 
         ...
         <InsertItemTemplate>
             <tr style="">
                 ...
                 <td>
                    ...
                    <asp:SqlDataSource ID="SQLDSJugadores" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" SelectCommand="SELECT CONCAT([INTCVEJUGADOR],'-', [VCHNOMBRE]) as nameJugador, [INTCVEJUGADOR] FROM [jugador]"></asp:SqlDataSource>
                 </td>
                  <td>
