...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <asp:SqlDataSource ID="SQLDSCartasDeCategoria" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" 
    ...
    <asp:SqlDataSource ID="dsIDCategoria" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" 
        SelectCommand="SELECT CONCAT ([INTIDCATEGORIA],' - ', VCHNOMBRE) AS detail, INTIDCATEGORIA FROM [categoria]">
    </asp:SqlDataSource>
    
    <asp:SqlDataSource ID="dsCartas" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" 
